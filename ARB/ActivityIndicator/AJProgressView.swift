...
class AJProgressView: UIView {
    ...
    public var imgLogo: UIImage = UIImage(named:"activity")!
   
    // Pass your color here which will be used as layer color
    public var firstColor: UIColor? = #colorLiteral(red: 0.9607843161, green: 0.7058823705, blue: 0.200000003, alpha: 1)
